...
gnuplot -e "set multiplot layout 2,1; set xrange [0:1270000]; set yrange [-100:-20]; set grid; plot 'exp0.dat' with lines linestyle 1, 'exp1.dat' with lines linestyle 3; set xrange [0:26]; set yrange [-90:-20]; plot 'Barcode0.dat' with lines  lw 2, 'Barcode0.dat' with points pt 7 lc 1, 'Barcode1.dat' with lines lw 2, 'Barcode1.dat' with points pt 7 lc 3; unset multiplot; pause -1"
